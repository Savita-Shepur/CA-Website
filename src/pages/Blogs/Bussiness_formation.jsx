  ...
  return (
    <>
      <Helmet>
        ...
        />
        <link rel="canonical" href="/services/comforReg/busReg" />
        <meta
          name="keywords"
          ...
          <div className="body">
            ...
            <div className="blog">
              ...
              <div className="ordered1">
                <ol>
                  <li>
                    Obtain Digital Signature Certificates (DSC) for all
                    directors
                  </li>
                  <li>Apply for Director Identification Numbers (DIN)</li>
                  <li>Reserve a unique company name</li>
                  <li>File incoReceive Certificate of Incorporation </li>
                  <li>
                    icorporation documents with the Ministry of Corporate
                    Affairs (MCA)
                  </li>
                </ol>
              </div>
