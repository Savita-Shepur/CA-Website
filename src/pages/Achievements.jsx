      ...
      <div className="Association" id="linkachieve">
        ...
        <div className="Achievemnets ">
          <div className="NewsBox">
            ...
            <h4>
              <b>1998</b> <br />
              Qualified as a CA CWA and SET examination in first attempt.{" "}
            </h4>
          </div>
          <div className="NewsBox">
            ...
            <h4>
              <b>1999</b> <br />
              Appointed as a Finance Strategist at Lokmat newspaper the Leading
              Marathi daily .
            </h4>
          </div>
          <div className="NewsBox">
            ...
            <h4>
              <b>2000</b>
              <br /> Designated as a Stratergy Partner with State Bank of India
          ...
          <div className="NewsBox">
            ...
            <h4>
              <b>2001</b> <br /> Achieved a business for 10k credit cards for
              State Bank of India.
            </h4>
          </div>
        </div>
        <div className="achbtn">
          <button
            className="readbtn text-white font-bold py-3 px-5  mt-1 transition-opacity duration-500"
            style={{
              height: "6vh",
              marginLeft: "12px",
            }}
